...
export default function InterestBreakDown() {
  ...
  return (
    <div className="flex flex-col items-center gap-8 px-20 py-4">
      ...
      <form className="flex flex-col items-center justify-center gap-6 rounded-2xl border-4 border-green-500 bg-lime-100 p-8 shadow-lg duration-300 hover:border-8 hover:border-lime-800 hover:shadow-xl">
